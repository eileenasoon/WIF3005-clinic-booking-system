...
<body style="background-image:url(images/yellowpage.jpg);height: 110%; background-repeat: no-repeat;" >
	...
	<div class="sucontainer" style="background-color:white">
		<ul style="background-color:white">			
			...
			<input type="text" name="doctorname" placeholder="Enter Doctor Name" style="margin-left:-30px;width:575px;" class="form-control"></input>
		...
		<div class="container">
			<div style="display:flex;justify-content:flex-end">
			<button type="submit" style="position:center; margin-left:-30px" name="submit" value="Submit" class="btn btn-dark">Submit</button>
			</div>
		</div>
<?php
session_start();
